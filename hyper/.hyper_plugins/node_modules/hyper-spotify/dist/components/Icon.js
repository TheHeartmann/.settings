...
var IconFactory = function IconFactory(React) {
  return (0, _radium2.default)(function (_ref) {
    var iconName = _ref.iconName,
        onClick = _ref.onClick,
        style = _ref.style;

    var iconStyle = iconName ? styles[(0, _lodash.capitalize)(iconName) + 'IconStyle'] : styles.SpotifyIconStyle;
    return React.createElement('div', {
      onClick: onClick,
      style: (0, _extends3.default)({}, styles.IconStyle, style, iconStyle)
    });
  });
};
